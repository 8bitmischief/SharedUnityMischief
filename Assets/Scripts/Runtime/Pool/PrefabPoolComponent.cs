...
namespace SharedUnityMischief.Pool
{
	public class PrefabPoolComponent : MonoBehaviour, IPool
	{
		...
		public GameObject Withdraw(Transform parent) => _pool.Withdraw(parent, transform.position, transform.rotation);
		public GameObject Withdraw(Vector3 position) => _pool.Withdraw(position, Quaternion.identity);
		public GameObject Withdraw(Transform parent, Vector3 position) => _pool.Withdraw(parent, position, Quaternion.identity);
		public GameObject Withdraw(Vector3 position, Quaternion rotation) => _pool.Withdraw(position, rotation);
		public GameObject Withdraw(Transform parent, Vector3 position, Quaternion rotation) => _pool.Withdraw(parent, position, rotation);

		public T Withdraw<T>() where T : MonoBehaviour => _pool.Withdraw<T>(transform.position, transform.rotation);
		public T Withdraw<T>(Transform parent) where T : MonoBehaviour => _pool.Withdraw<T>(parent, transform.position, transform.rotation);
		public T Withdraw<T>(Vector3 position) where T : MonoBehaviour => _pool.Withdraw<T>(position, Quaternion.identity);
		public T Withdraw<T>(Transform parent, Vector3 position) where T : MonoBehaviour => _pool.Withdraw<T>(parent, position, Quaternion.identity);
		public T Withdraw<T>(Vector3 position, Quaternion rotation) where T : MonoBehaviour => _pool.Withdraw<T>(position, rotation);
		public T Withdraw<T>(Transform parent, Vector3 position, Quaternion rotation) where T : MonoBehaviour => _pool.Withdraw<T>(parent, position, rotation);
